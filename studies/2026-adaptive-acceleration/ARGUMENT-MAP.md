...
### Steam and factory production

Steam adoption raised productivity and weakened geographic constraints, while larger establishments captured disproportionate gains [H01][H02]. Worker resistance often concerned wages, control, and production relations rather than a metaphysical rejection of machinery [H03]. British restrictions on exporting machinery and skilled labor became contradictory and difficult to enforce [H04].

### Electrification

Electricity's gains depended on capital deepening and organizational change, not merely replacing one power source with another [H05]. This supports the complementarity thesis: a general-purpose technology produces value through downstream reorganization.

### Computing and information technology

General-purpose technologies are pervasive, improve over time, and stimulate complementary invention [H06]. IT value depended on workplace and organizational co-invention [H07], while intangible complementary investment can create a productivity J-curve [H08].

### Technology diffusion

Technology adoption varies dramatically across countries; education, openness, implementation capacity, and incumbent barriers shape diffusion [H09][H10][H11]. Differences in penetration can explain a large share of long-run income divergence [H12].
...
Accelerate:
  ...
  failure recovery
  education and labor adaptation
  benefit diffusion
