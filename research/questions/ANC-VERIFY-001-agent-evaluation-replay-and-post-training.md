...
Only after R3 produces stable valid repeated Trial groups does [`../experiments/experiment-loop-v0/`](../experiments/experiment-loop-v0/) begin. CEL-R4 is the first consumer of the Agent-first research method in [`../research-method-v1.json`](../research-method-v1.json): separate Proposer, Implementer, Evaluator, and Search Controller roles autonomously advance bounded private/reversible research, while human attention is reserved for purpose or consequence changes and product/domain owners retain their existing authority. Its first live self-customer is Observation Gateway optimization; it does not activate unrestricted self-evolution or create a production experiment platform. Promotion beyond Track R still requires repeated consumers and measurable net deletion elsewhere.
