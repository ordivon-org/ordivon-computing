# Computational Possibility Negative and Superseded Results

Preserved negative results include:

- no `Foundation0`;
- no numbered current CP Foundation;
- historical `AlgF0` is not restored as current;
- the Derived-Theory Basis is not a disguised numbered Foundation;
- specialist routes are not a primitive numbering sequence;
