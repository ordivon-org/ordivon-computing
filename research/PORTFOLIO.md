...
| 2026-ai-capability-governance-and-private-power | active | G0-G2 capability-governance scope, evidence discipline, cross-disciplinary theory map, and research-local power grammar and schemas | Run G3 exact revision-bound OpenAI and Anthropic cases; do not rank Providers or promote shared architecture before G4-G6 comparative and controlled evidence. |
