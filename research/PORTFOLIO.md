...
| 2026-cross-layer-attack-chains | completed | R4 official case reconstruction across cloud authority, Exchange, request smuggling, BGP/DNS/TLS, supply-chain identity, cache persistence, Agent hijacking, and duplicate Effects | Use as the real-chain and residual-closure baseline; admit R5 only as one minimal owned comparative range with explicit deletion outcomes. |
