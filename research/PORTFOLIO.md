...
| 2026-ai-capability-governance-and-private-power | active | G0-G7 capability-governance theory, revision-bound Provider and regulatory cases, controlled layer/surface observations, and research-local governance/dependency graphs | Run the requested full review; decide retain, freeze, revalidate, split, or delete. G8 architecture feedback is intentionally omitted. |
