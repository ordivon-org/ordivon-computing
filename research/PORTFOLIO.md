...
| 2026-minimal-adversarial-range-r5 | completed | R5 deterministic owned range with 176 Agent-hijacking, response-loss, and interpretation-differential Trials plus exact Host/Game contract observations | Use the retained thin contracts; R6 may replace synthetic policies with real model/Host profiles, held-out attacks, deliberate Context loss, and Host replacement without building a larger platform. |
