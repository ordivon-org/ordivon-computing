...
| ANC-HUMAN-001 | M2 | reference | ordivon-human | — | 045994bc53d1 | — | Consume the practical E0–E9 transition path as a reference in concrete Ordivon decisions. Reopen only on contradictory owner evidence or a complete case that the retained mechanism ranks incorrectly; do not create an automatic E10, person model, score, or implementation platform. | A simpler model explains real Ordivon cases without separate terminal-outcome, ownership, leverage, continuity, attention, human–AI capability, or autonomy distinctions, or those distinctions do not change a concrete design or evaluation. |
