...
| 2026-web-semantic-differentials | completed | R2 HTTP framing and transitions, URL/encoding order, field metadata, content typing, cache equivalence, downstream interpreter, and Agent differential-discovery baseline | Use as the interpretation-path model; continue with the non-operational R3 network naming, routing, transport, encryption, and partial-failure study. |
