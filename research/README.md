...
The completed G0-G7 AI capability-governance study—compact claim and power boundaries, dated Provider and institutional snapshots, R6-backed intervention-layer evidence, and the governance/dependency distinction—lives in [`../studies/2026-ai-capability-governance-and-private-power/`](../studies/2026-ai-capability-governance-and-private-power/). Its unused Schemas, generators, Validators, and derived JSON were deleted at closeout. It creates no shared governance service, Provider score, or G8 architecture change.
