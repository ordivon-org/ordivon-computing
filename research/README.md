...
The G0-G2 AI capability-governance study—claim boundaries, evidence and revision discipline, political and institutional theory, infrastructure and epistemic power, exit and polycentric alternatives, and research-local case schemas—lives in [`../studies/2026-ai-capability-governance-and-private-power/`](../studies/2026-ai-capability-governance-and-private-power/). It separates Provider refusal, model capability, Host and Runtime admission, World Effect, normative justification, contestability, and exit; it does not create a shared governance service or rank Providers before comparative and controlled evidence.
