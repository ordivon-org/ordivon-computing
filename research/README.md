...
- [`experiments/finance-conclusion-admission-dogfood-v0/`](experiments/finance-conclusion-admission-dogfood-v0/) — real-domain Finance dogfood showing schema-valid execution intent can fail owner admission, that admission feedback can correct a live Agent, and that Harness conclusion feedback/budget accounting currently collapse distinct mechanics;
