...
The R5 minimal owned adversarial range—176 deterministic Agent-hijacking, response-loss, and interpretation-differential Trials plus exact Host/Game contract observations—lives in [`experiments/adversarial-range-r5/`](experiments/adversarial-range-r5/). It retained existing provenance, candidate admission, ToolGrant, Effect, `UNKNOWN`, reconciliation, typed-boundary, verifier, and reset responsibilities while rejecting a universal Security platform.

The R6 real-model adversarial transfer—34 formal DeepSeek V4 Trials, 220 model calls, 230 Tool calls, live Runtime Canary consequences, structural Tool-description poisoning, exact ACI schema repair, and native typed-denial recovery—lives in [`experiments/adversarial-transfer-r6/`](experiments/adversarial-transfer-r6/) with its closeout in [`../studies/2026-real-model-adversarial-transfer-r6/`](../studies/2026-real-model-adversarial-transfer-r6/). It proved that Tool metadata can redirect real Agent action under ambient authority, that Assignment-scoped ToolGrant cuts world consequence, and that deterministic denial can remain recoverable without turning Runtime `UNKNOWN` into retry.

The G0-G7 AI capability-governance study—claim boundaries, evidence and revision discipline, cross-disciplinary power theory, revision-bound OpenAI/Anthropic cases, a seven-Provider ecology, EU/US/China/Canada and compute governance, 44 controlled observations, and research-local governance/dependency graphs—lives in [`../studies/2026-ai-capability-governance-and-private-power/`](../studies/2026-ai-capability-governance-and-private-power/). It separates Provider policy, model proposal, Host/Runtime admission, World Effect, contestability, and exit; it creates no shared governance service, Provider score, or G8 architecture change.
