...
- [`CIVILIZATION-MEDIATED-REACHABILITY-WORLD-MODEL-REVISION-20260826.md`](CIVILIZATION-MEDIATED-REACHABILITY-WORLD-MODEL-REVISION-20260826.md) — source-neutral reachability correction: `NotOwned != NotReachable`, civilization-realized capability is candidate path evidence rather than current Ordivon capability, blockers must be classified explicitly, and candidate/path-qualified/realized capability remain separate;
- [`HISTORICAL-REACHABILITY-EVIDENCE-ECOLOGY-REVISION-20260826.md`](HISTORICAL-REACHABILITY-EVIDENCE-ECOLOGY-REVISION-20260826.md) — post-experiment contraction of historical reachability and evidence ecology: rejects the unstable T1–T10 ontology and natural-pressure-only hierarchy, retains minimal causal delta plus claim-ceiling discipline, and records HR0–HR4 evidence/counter-models/carrier substitution;
...
- [`SOURCE-HORIZON-ADMISSION-MODEL-20260829.md`](SOURCE-HORIZON-ADMISSION-MODEL-20260829.md) — operation-relative source-horizon model derived from Harness/Atlas/SCD/World changed-consequence cases plus Game/Finance negative controls: separates exact source, present source horizon, owner truth and deployment; retains authority-carrier absence, capability absence, superseded-valid current pointer and phantom capability as diagnostics without creating a generic resolver.
- [`ORDIVON-RESEARCH-CAPABILITY-ECOLOGY-AUDIT-CLOSEOUT-20260827.md`](ORDIVON-RESEARCH-CAPABILITY-ECOLOGY-AUDIT-CLOSEOUT-20260827.md) — parent capability-ecology audit separating demonstrated research operations, methods, instruments, representations and consequence standing without collapsing them into one workflow or score.
- [`RESEARCH-CAPABILITY-EVALUATION-CLOSEOUT-20260827.md`](RESEARCH-CAPABILITY-EVALUATION-CLOSEOUT-20260827.md) — bounded historical-forensics + sealed-rediscovery + interactive active-discovery closeout: sharpens existing PS-A with replicated dynamic current decision-surface evidence while preserving PS-B open-world acquisition and PS-C prospective calibration as unresolved; no new theory, owner, capability-map row, Harness product surface or F14/F17 mutation is admitted.
...
- [`experiments/eda-open-basis-reconciliation-v0/`](experiments/eda-open-basis-reconciliation-v0/) — canonical exact-byte archive of detached EDA open-basis revision `22f6c33`: preserves the KiCad 10.0.5 baseline/provider receipt, bounded mutation grammar evidence, Standing/open-basis trials, exact historical `GRID_A` Agent Effect, and a current-provider replay carrier without promoting full Agent-operated EDA authoring or restoring the divergent research world as current authority;
- [`experiments/eda-kicad-ngspice-bridge-v0/`](experiments/eda-kicad-ngspice-bridge-v0/) — current bounded electronic-design consequence bridge: exact R3/C2 identity/value/topology emitted by KiCad crosses an explicit owner-selected subnetwork contract into ngspice 47, where the cutoff response matches an independent analytic RC oracle; full-schematic simulation/model completeness remains unclaimed;
- [`experiments/eda-kicad-bounded-revision-loop-v0/`](experiments/eda-kicad-bounded-revision-loop-v0/) — current narrow KiCad P5 role validation for bounded semantic schematic revision: exact precondition + wire/endpoint binding, machine-checked connectivity/ERC/PCB parity and fabrication outputs, stale-repeat rejection, and exact source/project recovery; this does not promote arbitrary schematic creation or PCB geometry authoring;
- [`experiments/cadquery-mechanical-authoring-reconciliation-v0/`](experiments/cadquery-mechanical-authoring-reconciliation-v0/) — current CadQuery 2.8.0 narrow P5 carrier for scripted parametric solid construction/revision + STEP export: 10/10 frozen CAD-v0 base/revision cases replay with historical-equivalent geometry metrics, current verifier falsifiers reject missing-hole/+2 mm artifacts, and provider-tournament optimality remains unclaimed;
- [`experiments/ngspice-circuit-simulation-reconciliation-v0/`](experiments/ngspice-circuit-simulation-reconciliation-v0/) — current ngspice 47 narrow P5 carrier for headless bounded circuit simulation: the RC transient analytic receipt replays byte-identically under the exact Workstation-bound binary, complementing the separate AC high-pass P6 bridge while physical/model-library truth remains unclaimed;
...
- [`LABORATORY-SYNTHETIC-ENGINEERING-FLOOR-CLOSEOUT-20260828.md`](LABORATORY-SYNTHETIC-ENGINEERING-FLOOR-CLOSEOUT-20260828.md) — current closeout of the first minimal synthetic engineering substrate: current narrow P5 carriers for CadQuery, KiCad and ngspice plus a bounded KiCad→ngspice P6 bridge satisfy the first-floor obligations; further provider breadth is pressure-driven while physical evidence and measurement discrimination become the next frontier.
- [`LABORATORY-E0B-SYNTHETIC-PHYSICAL-BRIDGE-PREREGISTRATION-20260828.md`](LABORATORY-E0B-SYNTHETIC-PHYSICAL-BRIDGE-PREREGISTRATION-20260828.md) — pre-data E0-B physical-bridge contract: frozen ngspice predictions for a 1 kΩ vs 4.7 kΩ hidden-resistor RC discriminator, explicit waveform/identity/measurement-validity admission, and a fail-closed `BLOCKED_BY_ACQUISITION_AND_RECEIPT` standing until actual Laboratory carriers are received and receipted.
- [`LABORATORY-E0B-CARRIER-DELETION-AUDIT-20260828.md`](LABORATORY-E0B-CARRIER-DELETION-AUDIT-20260828.md) — pre-data carrier subtraction for the first physical bridge: Pico 2 stimulus + AD3 two-channel observation preserves the E0-B discriminator while removing SDS824X HD from the deletion-essential first-contact set; the bench scope remains approved long-horizon capital rather than being rejected.
- [`LABORATORY-E0B-ARRIVAL-REENTRY-CONTRACT-20260828.md`](LABORATORY-E0B-ARRIVAL-REENTRY-CONTRACT-20260828.md) — post-delivery E0-B re-entry ladder separating arrival, object identity, Workstation attachment binding, provider generation, static-reference/component fitness, classifier blinding, waveform validity, low-energy admission, pre-reveal classification and final reveal; it is a recipe rather than a device-registry service.
- [`LABORATORY-E0B-MEASUREMENT-INFORMATION-CONTRAST-20260828.md`](LABORATORY-E0B-MEASUREMENT-INFORMATION-CONTRAST-20260828.md) — pre-data information-content falsifier for E0-B: AD3 input loading leaves the frozen dynamic bands separated while static DC remains non-discriminating at the planning accuracy bound; a positive claim now requires `STATIC_AMBIGUOUS -> active dynamic unique model -> reveal agreement`.
- [`LABORATORY-E0B-PRE-ARRIVAL-SOFTWARE-READINESS-20260828.md`](LABORATORY-E0B-PREARRIVAL-SOFTWARE-READINESS-20260828.md) — bounded node readiness cut for the first physical bridge: common build tools exist, but Pico/WaveForms provider surfaces were not found in the checked paths; software installation is deliberately deferred because physical arrival/identity is the earlier blocking cut and future provider generation should be selected against the actual carrier.
- [`LABORATORY-FIRST-ORDER-ACQUISITION-RECONCILIATION-20260828.md`](LABORATORY-FIRST-ORDER-ACQUISITION-RECONCILIATION-20260828.md) — canonical reconciliation of the exact 2026-08-27 five-file first-order procurement packet: historical bytes/identities are preserved, structural portfolio logic survives, transaction/price/stock currentness is explicitly stale/UNKNOWN until re-observed, and current E0-B work contracts only the first-Reality-contact staging rather than rejecting the broader portfolio.
- [`LABORATORY-FIRST-ORDER-ACQUISITION-STAGING-20260828.md`](LABORATORY-FIRST-ORDER-ACQUISITION-STAGING-20260828.md) — pressure-driven transaction staging for the canonical first-order portfolio: R0 contains only the deletion-essential E0-B Reality-contact carriers; later R1 observation/metrology, energy/redundancy, construction and mechanical/visual groups promote only under concrete consumers; R2 remains JIT. No stage inherits stale price/stock truth or payment authority.
- [`LABORATORY-PHYSICAL-FOUNDATION-KERNEL-RECONCILIATION-20260828.md`](LABORATORY-PHYSICAL-FOUNDATION-KERNEL-RECONCILIATION-20260828.md) — exact-byte restoration and current-role reconciliation for the eight detached physical foundations directly load-bearing for E0/E1 definitions, safety, device identity, electronics, object lineage, target-relative metrology and evidence continuity; dated `CURRENT` labels remain historical and do not compete with current Reality/E0-B/Workstation/Runtime authority.
- [`LABORATORY-DETACHED-RESEARCH-CARRIER-AUDIT-CLOSEOUT-20260828.md`](LABORATORY-DETACHED-RESEARCH-CARRIER-AUDIT-CLOSEOUT-20260828.md) — closes the remaining detached Laboratory source audit after targeted restoration: 22 detached-only files are classified as stale Reality snapshots, newer-carrier-subsumed semantics, JIT/site-bound work, non-load-bearing family foundations or historical synthesis; five residual predecessor/companion mentions are historical navigation only, with zero modern current basename dependencies and explicit reopen conditions.
- [`LABORATORY-E0-PROGRAMME-CONTRACTION-20260828.md`](LABORATORY-E0-PROGRAMME-CONTRACTION-20260828.md) — post-E0-B v0.3 deletion audit of the restored frozen physical programme: E0-A remains a no-new-capital command/effect contradiction control, E0-C remains the unique response-loss/UNKNOWN reconciliation falsifier, E0-D needs only two Pico instances total, and E0-E becomes cross-modality replication rather than a mandatory E0 closure gate.
- [`LABORATORY-E1-ADMISSION-CONTRACTION-20260828.md`](LABORATORY-E1-ADMISSION-CONTRACTION-20260828.md) — keeps E1 dormant/JIT until contracted E0 physical evidence and a unique cross-physics consumer exist; retains force-motion complementarity, independent actuator-energy authority, external physical-state change and remount/currentness as the four unique claims, while demoting the detached specific motor/lever/load-cell geometry to historical candidate rather than current purchase/build authority.
- [`LABORATORY-PRE-PHYSICAL-DESIGN-CLOSEOUT-20260828.md`](LABORATORY-PREPHYSICAL-DESIGN-CLOSEOUT-20260828.md) — closes the current pre-physical design phase after synthetic/E0/E1/source/acquisition contraction: the next minimum blocking cut is fresh R0 physical-carrier Reality (already-owned evidence or explicit checkout→arrival), so SDK installation, E1 geometry, R1 purchases, specialist software and further historical restoration remain stopped until new Reality or a concrete consumer reopens them.
