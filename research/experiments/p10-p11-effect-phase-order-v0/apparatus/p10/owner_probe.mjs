...
const scenarios=[]; for(const n of ['new_unchanged','new_material_drift','admitted_response_lost_pre_dispatch','post_dispatch_ambiguous','post_dispatch_unbound','post_dispatch_accepted_response_lost']) scenarios.push(await scenario(n));
console.log(JSON.stringify({schemaVersion:1,kind:'ordivon.computing.p10-finance-owner-phase-probe',financeRevision:'999672a068e1de16b59516cd1079f7d504e81a47',actions,scenarios},null,2));
