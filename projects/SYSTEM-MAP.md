...
| `ordivon-host` | durable-task-continuity-commitment-verification-and-outcome-plane | https://github.com/zycxfyh/ordivon-host |
| `ordivon-harness` | caller-neutral-agent-run-provider-tool-and-recovery-plane | https://github.com/zycxfyh/ordivon-harness |
| `ordivon-world` | carrier-for-provider-native-external-adapters-and-private-network-tools | https://github.com/zycxfyh/ordivon-world |
| `ordivon-game` | open-interactive-games-and-persistent-virtual-worlds-for-people-and-agents | https://github.com/zycxfyh/ordivon-game |
